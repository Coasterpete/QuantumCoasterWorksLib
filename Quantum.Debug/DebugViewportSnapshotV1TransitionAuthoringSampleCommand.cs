...
{
    public static class DebugViewportSnapshotV1TransitionAuthoringSampleCommand
    {
        public const string CommandName = "debug-viewport-snapshot-v1-transition-authoring";
        public const int CenterlineSampleCount = TransitionAuthoringProofScenario.FrameCount;
        public const int TrainCarCount = TransitionAuthoringProofScenario.TrainCarCount;

        internal const string DefaultRelativeOutputPath =
            "artifacts/debug-viewport/DebugViewportSnapshotV1.transition-authoring.sample.json";
        ...
        public static int Run(string? outputPath = null)
        {
            ...
            Console.WriteLine($"Wrote transition-authoring DebugViewportSnapshotV1 sample to '{resolvedOutputPath}'.");
        ...
        {
            return TransitionAuthoringProofScenario.CreateDeterministic().Snapshot;
        }
