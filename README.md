...
- `dotnet run --project Quantum.Debug -- distance-inspection-browser [outputPath]`: write a self-contained static HTML preview for the deterministic `DistanceInspectionSnapshotV1` sample under `artifacts/track/`.
